...
Post-Build Command = 	cd ./Debug && move hyperscan.elf.bin Hyper.Exe	cd ./Debug && del *.o *.bin *.map *.d *.srec *.dbg *.res
...
Enable OSInfo = 0
OSInfo Dll = 
Project Path = C:\Users\ppcasm\Documents\score-sdk\examples\hyperscan\all\testing2
OSInfo INIT = 
Show Cycles = 0
Exception Debug = 0
ROM Debug = 0
