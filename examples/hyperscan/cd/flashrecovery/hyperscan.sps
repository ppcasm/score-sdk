...
Pre-Link Description = buildpatch
Pre-Link Command = 	python bintoheader.py .\RescuePatch\Debug\Hyper.Exe .\flash_patch.h
...
Enable OSInfo = 0
OSInfo Dll = 
Project Path = C:\Users\ppcasm\Documents\score-sdk\examples\hyperscan\cd\flashrecovery
OSInfo INIT = 
Show Cycles = 0
Exception Debug = 0
ROM Debug = 0
