...
Compiler AddFlag = -Dhyperscan -Dmax_heap_size=3*(512*1024)
...
Post-Build Command = 	cd ./Debug && move hyperscan.elf.bin ..\..\cdusbldr.bin	cd ./Debug && del *.o *.bin *.elf *.map *.d *.srec *.dbg *.res
...
Enable OSInfo = 0
OSInfo Dll = 
Project Path = C:\Users\ppcasm\Documents\score-sdk\examples\hyperscan\cd\usbloadercd\usbloadcd
OSInfo INIT = 
Show Cycles = 0
Exception Debug = 0
ROM Debug = 0
